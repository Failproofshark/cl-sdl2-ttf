...
(defun create-open-gl-text (font text red green blue alpha &key (depth 8) (pitch 32) (power-of-2 'nil))
  ...
  (let ((original-surface (render-text-blended font text red green blue alpha)))
    (autocollect (ptr)
